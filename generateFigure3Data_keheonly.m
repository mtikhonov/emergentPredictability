function [clark,kehe] = generateFigure3Data_keheonly(REPROCESS,options)
if exist('/data/jmoran/figure3_data_vKeheOnly.mat','file') && ~REPROCESS
    fprintf('Dataset has already been preprocessed. Loading from disk...\n')
    load('/data/jmoran/figure3_data_vKeheOnly.mat','clark','kehe')
else
    %% Load processed data
    ...
    save('/data/jmoran/figure3_data_vKeheOnly.mat','kehe')
end
