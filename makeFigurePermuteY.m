...
for obs = 1:length(observables)
    ...
    if obs < length(observables)
        ...
        x2plt = clark.highdiv{obs}.permuteY.desc_complexity;
        y2plt = clark.highdiv{obs}.permuteY.FVUmedian;
        negerr2plt = y2plt - clark.highdiv{obs}.permuteY.FVUlower;
        poserr2plt = clark.highdiv{obs}.permuteY.FVUupper - y2plt;
        ...
        negerr2plt = y2plt - kehe.middiv.permuteY.FVUlower;
        poserr2plt = kehe.middiv.permuteY.FVUupper - y2plt;
